...
import { admin as adminCopy, empty, events as eventsCopy } from "@/lib/copy";
        ...
        <ul className="space-y-2">
          {events.map((event) => (
            ...
            >
              <div className="min-w-0 space-y-1">
                ...
                <p className="text-xs text-muted">
                  {[
                    ...
                    event.location,
                    event._count.entries === 1 ? "1 projeto" : `${event._count.entries} projetos`,
                  ]
                    .filter(Boolean)
                    .join(" · ")}
                </p>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <ButtonLink href={`/admin/events/${event.id}`} size="sm" variant="secondary">
